# BhoomiSetu - MERN Responsive Starter

This archive contains a minimal MERN scaffold (backend + frontend). Frontend is a Vite + React skeleton; backend is Express + Mongoose.
